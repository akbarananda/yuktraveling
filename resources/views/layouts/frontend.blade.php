...
<body>
    ...
    <header class="header" id="header">
        <nav class="nav container">
            <a href="{{ route('homepage') }}" class="nav__logo"><img class="mr-3"
                    src="{{ asset('frontend/assets/img/logo2.png') }}" alt="" width="50px"
                    style="margin-right: 10px">YukTraveling</a>
            ...
            <a target="_blank" href="{{ route('admin.dashboard') }}" class="button nav__button">Booking Now</a>
        </nav>
    </header>
        ...
        <div class="footer__container container grid">
            <div>
                <a href="{{ route('homepage') }}" class="footer__logo">
                    <img class="mr-3" src="{{ asset('frontend/assets/img/logo2.png') }}" alt=""
                        width="50px" style="margin-right: 10px">YukTraveling
                </a>
